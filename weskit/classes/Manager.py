    ...
    def _prepare_workflow_path(self,
        ...
        * Absolute trs://-URIs
        ...
        if workflow_url.scheme in ["file", '']:
            ...
            elif self.remote_config is not None:
                # Assuming the workflow path is relative to the remote shared working directory
                workflow_path_rel = os.path.join(self.remote_config["lsf_submission_host"]
                                                 ["bsub_params"]["shared_workdir"], workflow_url.path)
            else:
        ...
        # installed workflow.
        # TODO: add remote check to confirm if the workflow path exists or not
